...
<table class="table table-hover">
    <thead>
    <tr>
        <th colspan="1">Número da Ocorrência</th>
        <th colspan="1">Ano</th>
        <th colspan="1">Data Registro</th>
    ...
    <?php if ($ocorrencias) : ?>
        <?php foreach ($ocorrencias as $ocorrencia) : ?>
            <tr>
                <td colspan="1"><?php echo $ocorrencia[0]; ?></td>
                <td colspan="1"><?php echo $ocorrencia[1]; ?></td>
                <td colspan="1"><?php echo $ocorrencia[3]; ?></td>
                <td colspan="3"><?php echo $ocorrencia[8]; ?></td>
